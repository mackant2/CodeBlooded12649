...
public class EncoderTesting extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        robot.BottomDrive.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        robot.TopDrive.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        ...
        while (!isStopRequested() && opModeIsActive()) {
                    ...
                    telemetry.addData("encoder left/right",  "position %7d :%7d",
                          robot.leftDrive.getCurrentPosition(),
                          robot.rightDrive.getCurrentPosition());
                   telemetry.addData("encoder bottom/top",  "position %7d :%7d",
