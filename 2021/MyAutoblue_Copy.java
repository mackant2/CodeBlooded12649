...
@Autonomous(name="MyAutoblue.java", group="chad")
public class MyAutoblue_Copy extends LinearOpMode {
    //
    DcMotor frontleft;
    DcMotor frontright;
    DcMotor backleft;
    ...
    Duckspinner.setPower(.8);
     sleep(4000);
     Duckspinner.setPower(0);
    
     strafeToPosition(-11.5, .5);
    sleep(1000);
    moveToPosition(-70.2, .5);
    //
